...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1120-erd-s-problem-1120-6d3a1817-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1120"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1120-erd-s-problem-1120-6d3a1817-v1",
      "problem_contract_sha256": "243bae61cbea6829c15023eb0d9bde2c3d6741b87e2cda0526e0e685ccb0137e",
      "problem_id": "problem:um-ep-1120-erd-s-problem-1120-6d3a1817",
      "route_id": "route:um-ep-1120-erd-s-problem-1120-6d3a1817-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1120-erd-s-problem-1120-6d3a1817-source-fidelity-01",
      "graph_id": "graph:um-ep-1120-erd-s-problem-1120-6d3a1817-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1120-erd-s-problem-1120-6d3a1817-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1120-erd-s-problem-1120-6d3a1817-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f\\in \\mathbb{C}[z]$ be a monic polynomial of degree $n$, all of whose roots satisfy $\\lvert z\\rvert\\leq 1$. Let $ E= \\{ z : \\lvert f(z)\\rvert \\leq 1\\}. $ What is the shortest length of a path in $E$ joining $z=0$ to $\\lvert z\\rvert =1$?"
          },
          "statement_sha256": "5d03542296c64a1c1c8eb75a82df30a4c59697dce3d013db25238ca424261f87"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1120-erd-s-problem-1120-6d3a1817-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1120-erd-s-problem-1120-6d3a1817-root",
      "route_id": "route:um-ep-1120-erd-s-problem-1120-6d3a1817-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1120-26750a1aec07",
        "url": "https://www.unsolvedmath.com/problems/EP-1120"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
